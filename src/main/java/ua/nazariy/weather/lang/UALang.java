...
public class UALang extends Language {
    public UALang(){
        ...
        HELP_COMMAND =
                """
                /service - щоб обрати необхібний погодний сервіс
                /lang [мова] - щоб обрати необхібну мову. Наприклад, /lang en - щоб обрати англійську
                /langs - щоб переглянути всі доступні мови
                /weather [місто] - щоб переглянути погоду в місті""";
